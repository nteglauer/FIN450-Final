...
for (button in info_buttons) {
  ...
  # Wait for a short period (adjust as needed) to ensure the tab content loads
  Sys.sleep(2)  # Adjust the sleep duration based on the page loading time
...
```{r box office mojo web scraping}
