...
Films also tend to do better the longer they are. However, the difference isn't as drastic between short and medium length films. Films were split into the following categories:
...
ggplot(length, aes(x = Length_Category, y = AvgRev, fill = Length_Category)) +
